...
do 
    mkdir ./para_MPI1/$core
    for ele_num in  {100,200,400,600,800,1000,1200,1400,1600,1800,2000}
    do 
        mkdir ./para_MPI1/$core/$ele_num
        for pro_num in {20,50,100,200}
        do
            echo "$core and $ele_num"
            mpirun -np $core ./mpi $ele_num $ele_num 100 >> ./para_MPI1/$core/$ele_num/$pro_num.txt
        done
    done
done